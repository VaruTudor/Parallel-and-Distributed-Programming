...
public class Polynomial implements Serializable {
    ...
    /**
     * Constructor with given degree. Coefficients will be randomly generated.
     * @param degree - the list of coefficients
     */
    ...
    /**
     * In case the degrees of the polynomials are different, the remaining ones must be added to the result.
     * The coefficients to be added are between the highest degree
     */
    ...
    /**
     * Generates a list of zeros and forms a polynomial having 0 as coefficients.
     * @param degree - the degree of the polynomial
     * @return a polynomial with all coefficients 0
     */
